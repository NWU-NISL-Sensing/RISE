...
def start():
    ...
    times = ['pos3'] ##test set
    train_name = ['pos4','pos1','pos2','pos5'] ##train set
    filepath = r'/root/RISE-Version2/Jupyter/AllSee_test/S5/data/' 
    filename = ['_wave_phase_40D']
    class_index = 3
    class_num = 6
