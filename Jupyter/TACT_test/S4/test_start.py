...
def start():
    ...
    myclassifier = [sklearn.ensemble.RandomForestClassifier(n_estimators=100,random_state=0),
                    svm.SVC(probability = True, break_ties=True, decision_function_shape='ovr', random_state=0),
    ...
    times = ['pos3'] ##test set
    train_name = ['pos1','pos2','pos4','pos5'] ##train set
    filepath = r'/root/RISE-Version2/Jupyter/TACT_test/S4/data/' 
    filename = ['_dtw_phase_12D']
    class_index = 1
    class_num = 6   
