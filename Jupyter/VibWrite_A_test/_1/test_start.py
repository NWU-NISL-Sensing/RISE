...
def start():
    ...
    filepath = r'/root/RISE-Version2/Jupyter/VibWrite_A_test/_1/data/' 
    filename = ['6']
    class_index = 0
    class_num = 15  
    ...
    data = sio.loadmat(filepath + 'difpeople_' + filename[0] + '_fft' + times[0] + '.mat')
    xx2 = data['data_fft']
    yy2 = data['label']
    yy2 = yy2.flatten()
    test_x = xx2
    ...
    for ii in train_name:
        data = sio.loadmat(filepath + 'difpeople_'  + filename[0] + '_fft' + ii+ '.mat')
        x1 = data['data_fft']
        y1 = data['label']
        y1 = y1.flatten()
