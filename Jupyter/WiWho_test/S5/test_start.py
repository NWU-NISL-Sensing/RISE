...
def start():
    ...
    times = ['chair2'] ##test set
    train_name = ['mid','bag','right','chair1'] ##train set
    filepath = r'/root/RISE-Version2/Jupyter/WiWho_test/data/' 
    filename = ['mobisys9_dwt9_label_startend30']
    class_index = 2
    class_num = 11  
